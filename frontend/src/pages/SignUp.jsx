...
function SignUp() {
  ...
  return (
    ...
    >
      <form
        className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px]'
      ...
      >
        ...
        <div className='w-full h-[60px] border-2 border-white bg-transparent text-white rounded-full text-[18px] relative'>
          <input
            ...
            className='w-full h-full rounded-full border outline-none bg-transparent placeholder-gray-300 px-[20] py-[10]'
        ...
        <p
          className='text-[white] text-[18px] cursor-pointer text-center'
